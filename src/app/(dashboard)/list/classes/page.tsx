...
const ClassListPage = async ({
  ...
  const renderRow = (item: ClassList) => (
    ...
    >
      <td className="flex items-center gap-4 p-4 text-gray-800 font-medium">{item.name}</td>
        ...
        <div className="flex items-center gap-2 px-2">
          ...
          {role === "admin" && (
            <>
              <div
                title="Edit Class"
                className="w-8 h-8 rounded-md bg-blue-100 flex items-center justify-center hover:bg-blue-300 hover:ring-2 hover:ring-blue-400 transition-all duration-300 shadow-md"
              >
                <FormContainer table="class" type="update" data={item} />
              </div>
              <div
                title="Delete Class"
                className="w-8 h-8 rounded-md bg-red-100 flex items-center justify-center hover:bg-red-300 hover:ring-2 hover:ring-red-400 transition-all duration-300 shadow-md"
              >
    ...
    <div className="bg-gradient-to-br from-white via-blue-50 to-purple-100 p-6 rounded-xl shadow-md flex-1 m-4 mt-0 font-sans">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">Overview of all school classes</p>
        </div>
